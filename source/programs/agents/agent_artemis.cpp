...
int32_t request_takephoto(string &request, string &response, Agent *agent);

int main(int argc, char **argv)
{
    cout << "Agent Artemis" << endl;
    Agent *agent;
    ...
    agent->add_request("takephoto", request_takephoto, "", "Takes a photo using the Raspi Camera");
